...
-- vim.g.rnvimr_draw_border = 10
-- vim.g.rnvimr_shadow_winblend = 80
-- vim.g.rnvimr_border_attr = { fg = 14, bg = -1 }
-- vim.g.rnvimr_enable_bw = 1
-- vim.g.rnvimr_ranger_cmd = { 'ranger', '--cmd=set draw_borders both', '--cmd=set preview_images true', '--cmd=set preview_images_method kitty' }
--vim.g.rnvimr_ranger_cmd = { 'ranger', '--cmd' }
-- vim.g.rnvimr_layout = {
--   relative = 'editor',
--   width = 1,
--   height = 1,
...
--   vim.cmd 'Ex' -- 或者 e . / Oil / NvimTreeOpen 等
-- end, { desc = 'Go to Neovim config folder' })
--
-- local ex_open = false
-- --
-- vim.keymap.set('n', '<C-e>', function()
--   if ex_open then
--     vim.cmd 'bd' -- 关闭 netrw buffer
--     ex_open = false
--   else
--     vim.cmd 'Ex'
--     ex_open = true
--   end
-- end, { desc = '[E]xplore toggle' })
--
...
vim.keymap.set('n', '<localleader>mi', ':MoltenInit<CR>', { desc = 'Molten Init', silent = true })
